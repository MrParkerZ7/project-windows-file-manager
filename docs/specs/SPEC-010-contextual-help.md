...
- **Nothing keeps a popup honest.** Help text has no test, no link to the code it describes, and no review gate. Four payloads had drifted from the behaviour they describe; all four were corrected on 2026-09-04 (`T-010a`), but the *structural* gap remains — nothing prevents the next drift:
